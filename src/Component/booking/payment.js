                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div id="container-border">
                        ...
                        <div className="form-check">
                            <input className="form-check-input" type="radio" name="payment" id="flexRadioDefault1" value="1" onChange={hanldeChange} defaultChecked />
                            <label className="form-check-label">
                                Thanh Toán Tại Cửa Hàng
                            </label>
                        </div>
                        <div className="form-check">
                            <input className="form-check-input" type="radio" name="payment" id="flexRadioDefault2" value="2" onChange={hanldeChange} />
                            <label className="form-check-label" >
                                Thanh Toán Online
                            </label>
                        </div>
